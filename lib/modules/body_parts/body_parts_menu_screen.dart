...
class BodyPartsMenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(isHebrew ? 'חלקי הגוף 👁️👂' : 'Body Parts 👁️👂'),
        centerTitle: true,
    ...
    return [
      {
        ...
        'onPressed': () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const BodyPartsLearningScreen(),
            ),
          );
        },
      },
      {
        ...
        'onPressed': () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const BodyPartsMatchingGame(),
            ),
          );
        },
      },
