...
class EmotionsLearningScreen extends StatefulWidget {
  const EmotionsLearningScreen({super.key});

  @override
  State<EmotionsLearningScreen> createState() => _EmotionsLearningScreenState();
}

class _EmotionsLearningScreenState extends State<EmotionsLearningScreen> {
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(child: Text(_isHebrew ? 'זמן למידה' : 'Learning Time', style: TextStyle(fontSize: responsive.titleSize, fontWeight: FontWeight.bold, color: Colors.amber.shade700), textAlign: TextAlign.center)),
                    SizedBox(width: 48),
                  ],
                ),
              ),
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: List.generate(_items.length, (index) => Container(margin: const EdgeInsets.symmetric(horizontal: 2), width: 8, height: 8, decoration: BoxDecoration(shape: BoxShape.circle, color: index == _currentIndex ? Colors.amber : Colors.amber.shade200)))),
              ),
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: responsive.spacing(20)),
                      Text(_isHebrew ? currentItem['nameHe']! : currentItem['nameEn']!, style: TextStyle(fontSize: responsive.fontSize(36), fontWeight: FontWeight.bold, color: Colors.amber.shade800), textAlign: TextAlign.center),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 12),
                    Expanded(child: KidButton(text: _isHebrew ? 'שמע שוב' : 'Repeat', icon: Icons.volume_up, onPressed: _speakCurrent, color: Colors.amber, height: 60)),
                    SizedBox(width: 12),
