...
class ProfessionsMatchingGame extends StatefulWidget {
  const ProfessionsMatchingGame({super.key});

  @override
  State<ProfessionsMatchingGame> createState() => _ProfessionsMatchingGameState();
}

class _ProfessionsMatchingGameState extends State<ProfessionsMatchingGame> {
  ...
  final List<Map<String, String>> _allItems = [
    ...
    {'emoji': '👷', 'nameHe': 'בנאי', 'nameEn': 'Builder'},
  ];
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(child: Text(_isHebrew ? 'משחק התאמה' : 'Matching Game', style: TextStyle(fontSize: responsive.titleSize, fontWeight: FontWeight.bold, color: Colors.indigo.shade700), textAlign: TextAlign.center)),
                    SizedBox(width: 48),
                  ],
                ),
              ),
              ...
              Container(
                ...
                decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(20), boxShadow: [BoxShadow(color: Colors.indigo.withOpacity(0.2), blurRadius: 8, offset: const Offset(0, 4))]),
                child: Column(
                  children: [
                    Text(_isHebrew ? 'איפה ה...' : 'Where is the...', style: TextStyle(fontSize: responsive.fontSize(22), color: Colors.grey.shade700)),
                    const SizedBox(height: 8),
                    Text(_isHebrew ? _correctItem['nameHe']! : _correctItem['nameEn']!, style: TextStyle(fontSize: responsive.fontSize(32), fontWeight: FontWeight.bold, color: Colors.indigo.shade700)),
                  ],
                ),
              ),
              SizedBox(height: responsive.spacing(20)),
                  ...
                  builder: (context, constraints) {
                    ...
                    return GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        Color borderColor = Colors.indigo.shade200;
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 8),
                                Flexible(flex: 1, child: Text(_isHebrew ? option['nameHe']! : option['nameEn']!, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.indigo.shade700), textAlign: TextAlign.center, maxLines: 1, overflow: TextOverflow.ellipsis)),
              ...
              Padding(padding: const EdgeInsets.all(16), child: KidButton(text: _isHebrew ? 'שמע שוב את השאלה 🔊' : 'Hear Question Again 🔊', icon: Icons.volume_up, onPressed: _speakQuestion, color: Colors.indigo, height: 60)),
            ],
          ),
        ),
      ),
